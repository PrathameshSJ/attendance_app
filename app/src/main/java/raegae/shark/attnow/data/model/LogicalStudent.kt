...
/**
 * A LogicalStudent represents a merged view of
 * one or more physical Student entities.
 *
...
data class LogicalStudent(
    ...
    /**
     * Physical student ID that should be used
     * for attendance marking and updates.
     *
    ...
    /**
     * All physical student IDs that belong
     * to this logical student.
     */
    ...
    /**
     * Ranges of active subscription periods (start to end)
     * derived from all merged entities.
